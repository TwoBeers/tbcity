	...
	$tbcity_coa = array(
		...
		'hide_titles' =>
						array(
							...
							'info'				=> __( 'Hide pages title in single page view', 'fastfood' ),
							'req'				=> '',
							'sub'				=> array( 'hide_frontpage_title', 'hide_pages_title', 'hide_selected_entries_title' )
						),
		'hide_frontpage_title' =>
						array(
							'group'				=> 'content',
							'type'				=> 'chk',
							'default'			=> 1,
		...
		'hide_selected_entries_title' =>
						array(
							'group'				=> 'content',
							'type'				=> 'txt',
							'default'			=> '',
							'description'		=> __( 'in selected pages', 'fastfood' ),
		...
		'quickbar' => array(
							...
							'type'			=> 'chk',
							'default'		=> 1,
							'description'	=> __( 'sliding menu', 'tbcity' ),
							'info'			=> __( 'show the sliding menu before posts', 'tbcity' ),
							'req'			=> '',
		),
		'browse_links' => array(
							'group'			=> 'elements',
		...
		'main_menu' => array(
							...
							'info'			=> __( 'show the main menu below the header', 'tbcity' ),
							'req'			=> '',
		),
		'primary_sidebar' => array(
							...
							'type'			=> 'chk',
							'default'		=> 1,
							'description'	=> __( 'primary sidebar', 'tbcity' ),
							'info'			=> __( 'show the primary sidebar', 'tbcity' ),
							'req'			=> '',
		),
		'jsani' => array(
							'group'			=> 'javascript',
