...
function tbcity_get_coa( $option = false ) {
	...
	$tbcity_coa = array(
		...
		'post_formats_standard' => array(
							...
							'type'			=> 'gro',
							'default'		=> 1,
							'description'	=> __( 'Posts archives' , 'tbcity' ),
							'info'			=> '',
							'sub'			=> array('post_formats_standard_title', 'post_formats_standard_content', '', 'post_collapse'),
							'req'			=> '',
		),
		...
		'featured_title' => array(
							...
							'info'			=> __( '', 'tbcity' ),
							'options'		=> array('avatar', 'thumbnail', 'nothing'),
							'options_l10n'	=> array(__('author avatar', 'tbcity'),__('post thumbnail', 'tbcity'),__('nothing', 'tbcity')),
							'req'			=> '',
		),
		...
		'js_basic' => array(
							...
							'info'			=> '',
							'req'			=> 'jsani',
							'sub'			=> array('js_basic_menu', 'js_basic_extra_info', 'js_basic_quickbar', 'js_basic_collapse_posts', 'js_basic_autoscroll', 'js_basic_video_resize'),
		),
		'js_basic_menu' => array(
							'group'			=> 'javascript',
							'type'			=> 'chk',
		...
		'js_basic_collapse_posts' => array(
							'group'			=> 'javascript',
							'type'			=> 'chk',
							'default'		=> 1,
							'description'	=> __( 'collapse posts', 'tbcity' ),
							'info'			=> __( 'slide up/down post content', 'tbcity' ),
							'req'			=> 'jsani',
							'sub'			=> false,
		),
